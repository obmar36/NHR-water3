...
const SCHEDULE = [
  { seg:'時段1',  time:'00:00–07:30', site:'離峰/夜間',  bill:'離峰',   cfg:{P4_100HP:51,P3_100HP:57}, band:'P1 1.8–3.1 / P2 2.0–3.3', note:'P1 依水位輔助' },
  ...
  { seg:'時段3',  time:'10:00–14:00', site:'日間高需求', bill:'半尖峰', cfg:{P2_150HP:55,P3_100HP:57}, band:'P2 2.0–3.3', note:'作業尖峰 ≠ 台電尖峰' },
  ...
  { seg:'時段6',  time:'22:30–24:00', site:'離峰/夜間',  bill:'半尖峰', cfg:{P4_100HP:51,P3_100HP:57}, band:'P1 1.8–3.1 / P2 2.0–3.3', note:'P1 依水位輔助' },
];
...
function stationSummary(motors){
  ...
  // 改善前基準（同需求下 P3@60+P2@60+P1@60，sheet 8 驗證）
